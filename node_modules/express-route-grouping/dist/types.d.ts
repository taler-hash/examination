...
export declare type Resources = 'index' | 'find' | 'create' | 'update' | 'patch' | 'delete';
...
export declare type ResourceHandler = (req: Request, res: Response, next: NextFunction) => any;
export declare type ResourceHandlers = {
